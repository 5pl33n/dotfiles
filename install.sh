...
yay -S --noconfirm zsh oh-my-zsh-git zsh-theme-powerlevel10k-git hyprland xdg-desktop-portal-gtk xdg-desktop-portal-hyprland wlogout wireplumber waybar tmux swaylock-effects-git swaybg dunst eza htop kitty neovim ripgrep firefox ttf-cascadia-code-nerd qt6-svg qt6-declarative sddm unzip polkit-kde-agent qt5-wayland qt6-wayland bluez-utils brightnessctl bluez tofi
